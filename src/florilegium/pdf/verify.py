...
def verify_pdf_candidate(*args, **kwargs):
    if "local_verify_pdf_candidate" in globals():
        return local_verify_pdf_candidate(*args, **kwargs)
    if "verify_pdf" in globals():
        return verify_pdf(*args, **kwargs)
    raise NotImplementedError("verify_pdf_candidate adapter could not find implementation")
