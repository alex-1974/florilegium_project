...
def analyze_path_semantics(*args, **kwargs):
    if "local_analyze_path_semantics" in globals():
        return local_analyze_path_semantics(*args, **kwargs)
    raise NotImplementedError("analyze_path_semantics adapter could not find implementation")
